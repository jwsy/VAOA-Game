(() => {
  ...
  var require_howler = __commonJS({
    "node_modules/howler/dist/howler.js"(exports) {
      (function() {
        "use strict";
        var HowlerGlobal2 = /* @__PURE__ */ __name(function() {
          this.init();
        }, "HowlerGlobal");
        HowlerGlobal2.prototype = {
          ...
          _unlockAudio: function() {
            ...
            var unlock = /* @__PURE__ */ __name(function(e) {
          ...
          _autoSuspend: function() {
            ...
            self._suspendTimer = setTimeout(function() {
              ...
              var handleSuspension = /* @__PURE__ */ __name(function() {
        ...
        Howl3.prototype = {
          ...
          play: function(sprite2, internal) {
            ...
            if (typeof sprite2 === "number") {
              id = sprite2;
              sprite2 = null;
            } else if (typeof sprite2 === "string" && self._state === "loaded" && !self._sprite[sprite2]) {
              return null;
            ...
            var start = self._sprite[sprite2][0] / 1e3;
            var stop = (self._sprite[sprite2][0] + self._sprite[sprite2][1]) / 1e3;
            sound._sprite = sprite2;
            sound._ended = false;
            var setParams = /* @__PURE__ */ __name(function() {
              sound._paused = false;
              sound._seek = seek;
              sound._start = start;
              sound._stop = stop;
              sound._loop = !!(sound._loop || self._sprite[sprite2][2]);
            }, "setParams");
            if (seek >= stop) {
              self._ended(sound);
              return;
            ...
            if (self._webAudio) {
              var playWebAudio = /* @__PURE__ */ __name(function() {
                self._playLock = false;
                setParams();
            ...
            for (var i = 0; i < ids.length; i++) {
              ...
              if (sound) {
                ...
                if (self._webAudio && sound._node && sound._node.bufferSource) {
                  sound._node.bufferSource.loop = loop2;
                  if (loop2) {
          ...
          seek: function() {
            ...
            if (sound) {
              if (typeof seek === "number" && seek >= 0) {
                ...
                var seekAndEmit = /* @__PURE__ */ __name(function() {
                  if (playing) {
                    self.play(id, true);
                  }
                  self._emit("seek", id);
                ...
                if (playing && !self._webAudio) {
                  var emitSeek = /* @__PURE__ */ __name(function() {
                    if (!self._playLock) {
                      seekAndEmit();
                    } else {
          ...
          _ended: function(sound) {
            ...
            var loop2 = !!(sound._loop || self._sprite[sprite2][2]);
        ...
        var Sound2 = /* @__PURE__ */ __name(function(howl) {
          this._parent = howl;
          this.init();
        }, "Sound");
        Sound2.prototype = {
        ...
        var cache = {};
        var loadBuffer = /* @__PURE__ */ __name(function(self) {
          var url = self._src;
          if (cache[url]) {
        ...
        var safeXhrSend = /* @__PURE__ */ __name(function(xhr) {
          try {
            xhr.send();
          } catch (e) {
            xhr.onerror();
        ...
        var decodeAudioData = /* @__PURE__ */ __name(function(arraybuffer, self) {
          var error = /* @__PURE__ */ __name(function() {
            self._emit("loaderror", null, "Decoding audio data failed.");
          }, "error");
          var success = /* @__PURE__ */ __name(function(buffer) {
            if (buffer && self._sounds.length > 0) {
              cache[self._src] = buffer;
              loadSound2(self, buffer);
            } else {
              error();
            }
          }, "success");
      ...
      (function() {
        ...
        var setupPanner = /* @__PURE__ */ __name(function(sound, type) {
          type = type || "spatial";
          if (type === "spatial") {
  ...
  var k2 = /* @__PURE__ */ __name(class {
    ...
    scale(t) {
      return new k2(this.x + this.w * t.x, this.y + this.h * t.y, this.w * t.w, this.h * t.h);
    }
    clone() {
      return new k2(this.x, this.y, this.w, this.h);
    }
    eq(t) {
  ...
  var no = a((i = {}) => {
      ...
      return S(new Promise((u, c) => {
        J(e, n).then((s) => {
          V(r).then((o) => o.json()).then((o) => {
            let d = o.meta.size;
            s.frames = o.frames.map((h) => new k2(h.frame.x / d.w, h.frame.y / d.h, h.frame.w / d.w, h.frame.h / d.h));
    ...
    function Xe(e, n = { loop: false, volume: 1, speed: 1, detune: 0, seek: 0 }) {
      ...
      let d = r.currentTime - o, h = null, m = { stop() {
        ...
        return y2 !== void 0 && (c.playbackRate.value = z(y2, ds, fs)), c.playbackRate.value;
      }, detune(y2) {
        return c.detune ? (y2 !== void 0 && (c.detune.value = z(y2, ps, ms)), c.detune.value) : 0;
      }, volume(y2) {
        return y2 !== void 0 && (s.gain.value = z(y2, Or, Ir)), s.gain.value;
      }, loop() {
        c.loop = true;
      }, unloop() {
        c.loop = false;
...
`)
      ...
      return { bind() {
        ...
        for (let g in m) {
          ...
          typeof y2 == "number" ? r.uniform1f(x2, y2) : y2 instanceof R ? r.uniformMatrix4fv(x2, false, new Float32Array(y2.m)) : y2 instanceof v ? r.uniform4f(x2, y2.r, y2.g, y2.b, y2.a) : y2 instanceof Fe ? r.uniform3f(x2, y2.x, y2.y, y2.z) : y2 instanceof L && r.uniform2f(x2, y2.x, y2.y);
        }
        this.unbind();
      } };
    }
    ...
    a(ln, "flush");
    function He() {
      t.gl.clear(t.gl.COLOR_BUFFER_BIT), i.background || pe({ width: F(), height: G(), quad: new k2(0, 0, F() * t.scale / Fr, G() * t.scale / Fr), tex: l.bgTex, fixed: true }), l.drawCalls = 0, l.transformStack = [], l.transform = new R();
    }
    __name(He, "He");
    a(He, "frameStart");
    function ze() {
    ...
    function pe(e) {
      ...
      if (e.width <= 0 || e.height <= 0)
        return;
      let n = e.width, r = e.height, c = Ye(e.origin || Ne).scale(f(n, r).scale(-0.5)), s = e.quad || new k2(0, 0, 1, 1), o = e.color || E(255, 255, 255), d = (h = e.opacity) != null ? h : 1;
    ...
    function Yr(e) {
      ...
      let n = (s = e.quad) != null ? s : new k2(0, 0, 1, 1), r = e.tex.width * n.w, u = e.tex.height * n.h, c = f(1);
      if (e.tiled) {
        ...
        for (let g = 0; g < o; g++)
          for (let y2 = 0; y2 < d; y2++)
            pe(D(P({}, e), { pos: (e.pos || f(0)).add(f(r * g, u * y2)).sub(m), scale: c.scale(e.scale || f(1)), tex: e.tex, quad: n, width: r, height: u, origin: "topleft" }));
      } else
    ...
    function hn(e) {
      ...
      Yr(D(P({}, e), { tex: n.tex, quad: r.scale(e.quad || new k2(0, 0, 1, 1)), uniform: e.uniform }));
    }
    __name(hn, "hn");
    a(hn, "drawSprite");
    ...
    function me(e) {
      ...
      let { charStyleMap: r, text: u } = $r(e.text + ""), c = u.split(""), s = n.qw * n.tex.width, o = n.qh * n.tex.height, d = e.size || o, h = f(d / o).scale(f(e.scale || 1)), m = h.x * s + ((Zn = e.letterSpacing) != null ? Zn : 0), g = h.y * o + ((er = e.lineSpacing) != null ? er : 0), y2 = 0, x2 = g, W = 0, O = [], M = [], ee = null, te = 0;
      for (; te < c.length; ) {
        let oe = c[te];
        oe === `
` ? (x2 += g, y2 = 0, ee = null, M.push(oe), O.push(M), M = []) : (e.width ? y2 + m > e.width : false) && (x2 += g, y2 = 0, ee != null && (te -= M.length - ee, oe = c[te], M = M.slice(0, ee)), ee = null, O.push(M), M = []), oe !== `
` && (M.push(oe), y2 += m, oe === " " && (ee = M.length)), W = Math.max(W, y2), te++;
      }
      O.push(M), e.width && (W = e.width);
      let Ae = [], Oe = f(e.pos || 0), _ = Ye(e.origin || Ne).scale(0.5), se = -_.x * m - (_.x + 0.5) * (W - m), Ie = -_.y * g - (_.y + 0.5) * (x2 - g), ut = 0;
      return O.forEach((oe, Bi) => {
        ...
        oe.forEach((ct, ji) => {
          ...
          if (Gt) {
            let _t = { tex: n.tex, quad: new k2(Gt.x, Gt.y, n.qw, n.qh), ch: ct, pos: f(Oe.x + Yi + se + Ni, Oe.y + $i + Ie), opacity: e.opacity, color: (tr = e.color) != null ? tr : E(255, 255, 255), scale: h, angle: 0, uniform: e.uniform, fixed: e.fixed };
            if (e.transform) {
      ...
      return { id: "pos", pos: f(...e), moveBy(...n) {
        ...
        if (this.solid && ((o = this.area) == null ? void 0 : o.shape) === "rect") {
          ...
          p.root.every((h) => {
            ...
            let y2 = { p1: f(0), p2: f(u, c) }, x2 = 1, W = g.p1, O = f(g.p1.x, g.p2.y), M = g.p2, ee = f(g.p2.x, g.p1.y), te = 0, Ae = { right: { p1: W, p2: O }, top: { p1: O, p2: M }, left: { p1: M, p2: ee }, bottom: { p1: ee, p2: W } };
            for (let _ in Ae) {
              let se = Ae[_];
              ...
              let Ie = Jt(y2, se);
              Ie != null && (te++, Ie < x2 && (x2 = Ie));
            }
            if (x2 < 1 && !(x2 === 0 && te == 1 && !ae(g, f(u, c)))) {
    ...
    function fi(e = {}) {
      ...
      return { id: "area", add() {
        ...
        c *= o.x, s *= o.y;
        let d = Ye(this.origin || Ne), h = ((x2 = this.pos) != null ? x2 : f(0)).add(this.area.offset).sub(d.add(1, 1).scale(0.5).scale(c, s));
    ...
    function Vt(e, n = {}) {
      ...
      __name(c, "c");
      return a(c, "calcTexScale"), { id: "sprite", width: 0, height: 0, frame: n.frame || 0, quad: n.quad || new k2(0, 0, 1, 1), animSpeed: (s = n.animSpeed) != null ? s : 1, load() {
...
`), font: U.fonts[rn], pos: f(r, -r), origin: "botleft", size: 16, width: F() * t.scale * 0.6, lineSpacing: r / 2, fixed: true, styles: { time: { color: E(127, 127, 127) }, info: { color: E(255, 255, 255) }, error: { color: E(255, 0, 127) } } });
  ...
  scene("game", () => {
    ...
    __name(handleTouchMouseStartMove, "handleTouchMouseStartMove");
    const avocado = add([
      sprite("avocado"),
    ...
    onUpdate("avocado", (r) => {
      if (r.isOFaced) {
        ...
        r.scale = vec2(avocado.dScale + Math.sin(time()) * 0.1);
      }
      if (avocado.dir && avocado.pos.x > 0 && avocado.pos.x < width() && avocado.pos.y > 0 && avocado.pos.y < height() && Math.abs(avocado.pos.x - avocado.dir.pos.x) > 10 && Math.abs(avocado.pos.y - avocado.dir.pos.y) > 10) {
    ...
    __name(movePlayerLeft, "movePlayerLeft");
    ;
    ...
    __name(movePlayerUp, "movePlayerUp");
    ;
    ...
    __name(movePlayerDown, "movePlayerDown");
    ;
    ...
    onUpdate("enemy", (e) => {
      e.scale = vec2(0.7 + 0.1 * Math.sin(time()));
    });
    onCollide("avocado", "enemy", (b2, e) => {
      if (e.is("rainbowpoop")) {
        score.value += 10;
        shake(12);
      } else {
    ...
    __name(updateMousePosText, "updateMousePosText");
    ;
